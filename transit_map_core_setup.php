...
var base_layer = new L.tileLayer('http://{s}.tiles.mapbox.com/v3/' + map_id_base + '/{z}/{x}/{y}.png', {
     maxZoom: max_zoom,
     attribution: attribution
 });

var labels_layer  = new L.tileLayer('http://{s}.tiles.mapbox.com/v3/'+map_id_labels+'/{z}/{x}/{y}.png', {
     maxZoom: max_zoom
 });
